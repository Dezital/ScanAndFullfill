  ...
  return (
    <div className="tabs">
      ...
      <div className="right-tabs">
        <div className="tabs-button contact-button"><a href="https://easyscanandfullfill.freshdesk.com/support/home" target="_blank" style={{textDecoration:"none",color:"white"}}>Contact Us</a></div>
      </div>
    </div>
  );
}
